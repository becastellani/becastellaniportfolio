export const portfolioData = {
  personal: {
    ...
    tagline: "Systèmes financiers haute échelle. Architecture qui survit à la production.",
    description: "Développeur Full Stack spécialisé dans les systèmes critiques, microservices et infrastructure. Je transforme des exigences complexes en code fiable, des requêtes optimisées aux pipelines orchestrés dans Kubernetes.",
  ...
  projects: [
    {
      id: 1,
      name: "FD SmartCheck",
      description: "Système académique de check-in par QR Code avec validation par géolocalisation. Sécurité via HMAC-SHA256 et protection anti-replay en temps réel.",
      longDescription: "Architecture de sécurité en couches pour le contrôle de présence académique, avec signatures cryptographiques, validation géospatiale et dashboard en temps réel.",
    ...
    },
    {
      id: 2,
      name: "ActionPlanner",
      description: "Système de gestion de tâches avec dashboard professionnel, CRUD complet et authentification. Frontend en Angular, backend en Node.js.",
      longDescription: "Gestion de tâches avec hiérarchie de projets, attribution d'équipes, suivi de progression et rapports exportables.",
    ...
    },
    {
      id: 3,
      name: "Price Tracker",
      description: "Système de suivi de prix avec web scraping concurrent en Go. Surveille les produits sur plusieurs e-commerces simultanément avec des alertes configurables.",
      longDescription: "Scraping parallèle avec goroutines, stockage de l'historique des prix, système d'alertes et API REST pour consommation externe.",
  ...
  education: [
    {
      ...
      period: "2023 — 2026",
      highlight: "TFE : Machine Learning pour la Prévention des Fraudes dans les Coopératives de Crédit",
    },
  ],
  ...
  about: {
    ...
    softSkills: ["Résolution de Problèmes", "Pensée Systémique", "Ownership", "Communication Technique", "Proactivité", "Leadership Technique"],
    skillGroups: [
      ...
      { label: "Bases de Données", items: ["MySQL", "PostgreSQL", "Oracle", "SQL Server", "Redis"] },
      { label: "Infrastructure", items: ["Kubernetes", "Docker", "RabbitMQ", "CI/CD", "Linux"] },
      { label: "Outils", items: ["Git", "Selenium", "Puppeteer", "REST APIs", "WebScraping"] },
    ],
  ...
  contact: {
    ...
    sectionTitleAccent: "",
    tagline: "Je suis ouvert aux conversations. Si vous avez quelque chose d'intéressant à discuter, envoyez-moi un message.",
    emailLabel: "Email",
    phoneLabel: "Téléphone",
    locationLabel: "Localisation",
    footerText: "Construit avec React + Vite",
    formTitle: "Envoyer un message",
    formSubtitle: "Je réponds sous 24h. Cela peut concerner des opportunités d'emploi, des collaborations techniques ou simplement une discussion sur la technologie.",
    formNameLabel: "Nom",
